...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = MyContext.getInstance().getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MyContext.getInstance().getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
